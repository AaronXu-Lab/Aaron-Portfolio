...
export interface ToolEntry {
  ...
  pwa: boolean;
  /** 卡片角标上的一枚技术标签（大写 mono 小胶囊，如 HTML5），与 PWA 徽标同槽位 */
  badge?: string;
  status: 'shipped' | 'wip';
  tags?: string[];
  date?: string;
...
export const games: ToolEntry[] = [
  {
    ...
    en: 'FLYING NINJA CAT',
    description:
      '童年 Flash 页游的纯 H5 重制：以 Canvas 还原跑、跳、射绳、摆荡与吃金币的经典手感，不需要 Flash 或模拟器。点击起跳，再次点击发射绳索，在夜空中一路向前；成绩只存在本机，纯本地游玩。',
    icon: '/tools/flying-ninja-cat/icon.png',
    iconAlt: '飞天忍者猫游戏图标',
    pwa: false,
    badge: 'HTML5',
    status: 'shipped',
    tags: ['Flash 怀旧', 'Canvas', '本地运行'],
    date: '2026.07',
  ...
  },
  {
    ...
    en: 'CANDY MATCH',
    description:
      '一场装进口袋的无限流糖果三消：限时完成随机出现的收集、积分与技能任务，赢取糖果券来兑换提示、技能糖、任务跳过与延时；四消、L 形与五消也会生成带连锁效果的技能糖。成绩只存在本机，支持离线游玩。',
